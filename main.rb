...
class Main
  def train(data_x, data_y, cost_function, learning_rate, epochs, iterations, regularization_l2)
    ...
    tmp = nn.fit(data_x, data_y, cost_function, learning_rate, epochs, iterations, regularization_l2)
...
main = Main.new
p main.train(train_set_x, train_set_y, cost_function, learning_rate, epochs, iterations, regularization_l2)
